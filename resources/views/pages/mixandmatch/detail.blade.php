...
<body class="font-sans text-gray-900 antialiased bg-white">
 ...
 <main class="max-w-screen-md mx-auto px-6 py-10 mb-32 relative">
    <!-- Tombol kembali -->
    <a href="{{ url('/mixandmatch') }}" 
       class="flex items-center text-gray-700 text-lg font-semibold hover:text-gray-900 transition mb-4">
    ...
    <div class="relative flex flex-col items-center">
      ...
      <div class="absolute left-1/2 top-[-60px] w-[420px] h-[520px] bg-white rounded-3xl shadow-lg -translate-x-1/2 -z-20 overflow-hidden">
        <!-- Lingkaran penuh di kanan -->
      ...
      <img src="{{ asset('images/clean-outfit.png') }}" 
          alt="Clean Outfit" 
          class="rounded-2xl w-[340px] object-contain relative right-[-60px] -mt-28 z-10">

      <!-- Kartu produk -->
      <div class="absolute left-[46%] top-[75%] transform -translate-x-1/2 -translate-y-1/3 bg-[#f9f9f9] rounded-2xl shadow-lg p-4 w-48 text-center z-20 mb-4">
