        ...
        <div class="flex justify-center mb-12">
            <div class="flex items-center text-sm font-medium">
                <div class="flex items-center text-black opacity-60">
                    <span
                        class="flex items-center justify-center w-6 h-6 bg-gray-200 text-gray-600 rounded-full text-xs mr-2">✓</span>
                    <span>Information</span>
                </div>
                <div class="w-12 h-px bg-black mx-4"></div>
                <div class="flex items-center text-black">
                    <span
                        class="flex items-center justify-center w-6 h-6 bg-black text-white rounded-full text-xs mr-2">2</span>
                    <span>Shipping</span>
                </div>
                <div class="w-12 h-px bg-gray-300 mx-4"></div>
                <div class="flex items-center text-gray-400">
                    <span
                        class="flex items-center justify-center w-6 h-6 border border-gray-300 rounded-full text-xs mr-2">3</span>
                    <span>Payment</span>
                </div>
            </div>
        </div>
                    ...
                    <form action="{{ route('checkout.shipping.store') }}" method="POST">
                        ...
                        <div class="space-y-4">
                            <label class="relative block cursor-pointer group">
                                <input type="radio" name="pengiriman" value="jne" data-price="20000"
                                    class="peer sr-only" required>
                                <div
                                    class="flex items-center justify-between p-5 rounded-xl border border-gray-200 bg-white hover:border-gray-400
                            ...
                            <label class="relative block cursor-pointer group">
                                <input type="radio" name="pengiriman" value="sicepat" data-price="18000"
                                    class="peer sr-only">
                                <div
                                    class="flex items-center justify-between p-5 rounded-xl border border-gray-200 bg-white hover:border-gray-400
                                peer-checked:border-black peer-checked:ring-1 peer-checked:ring-black peer-checked:bg-gray-50 transition">
                            ...
                            <label class="relative block cursor-pointer group">
                                <input type="radio" name="pengiriman" value="gosend" data-price="25000"
                                    class="peer sr-only">
                                <div
                                    class="flex items-center justify-between p-5 rounded-xl border border-gray-200 bg-white hover:border-gray-400
                                peer-checked:border-black peer-checked:ring-1 peer-checked:ring-black peer-checked:bg-gray-50 transition">
