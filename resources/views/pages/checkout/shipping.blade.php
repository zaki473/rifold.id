                ...
                <form action="{{ route('checkout.payment') }}" method="POST">
                    ...
                    <div class="space-y-4">
                        <label class="flex items-center justify-between border p-3 rounded-lg cursor-pointer">
                            ...
                            <span>Rp 20.000</span>
                            <input type="radio" name="pengiriman" value="jne" class="ml-3">
                        </label>

                        <label class="flex items-center justify-between border p-3 rounded-lg cursor-pointer">
                            <span>SiCepat Express</span>
                            <span>Rp 18.000</span>
                            <input type="radio" name="pengiriman" value="sicepat" class="ml-3">
                        </label>

                        <label class="flex items-center justify-between border p-3 rounded-lg cursor-pointer">
                            <span>GoSend Same Day</span>
                            <span>Rp 25.000</span>
                            <input type="radio" name="pengiriman" value="gosend" class="ml-3">
                        </label>
                    </div>
