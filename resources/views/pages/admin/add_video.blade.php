...
<head>
    ...
    <title>Rifold Dashboard Admin - Add Video Home</title>
...
<body class="flex bg-gray-100">
    ...
    <main class="flex-1 ml-64">
        ...
        <div class="p-8">
            <h2 class="text-2xl font-semibold mb-4">Add video home</h2>
            <div class="bg-white rounded-lg shadow p-6">
                <h3 class="text-xl font-semibold mb-4 border-b pb-4">Add video home</h3>

                {{-- Form Start --}}
                <form action="{{-- URL untuk menyimpan video home --}}" method="POST" enctype="multipart/form-data">
                    @csrf

                    {{-- Video on home --}}
                    <div class="mt-6">
                        <label class="block text-sm font-medium text-gray-700">Video on home</label>
                            ...
                            <div class="space-y-1 text-center">
                                <div class="mx-auto h-12 w-12 text-gray-400 bg-gray-100 rounded-full flex items-center justify-center">
                                     <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-4-4V7a4 4 0 014-4h5l5 5v11a4 4 0 01-4 4H7z" />
                                ...
                                <div class="flex text-sm text-gray-600 justify-center">
                                    <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-black hover:text-indigo-500 focus-within:outline-none">
                                        ...
                                        <input id="file-upload" name="home_video" type="file" class="sr-only" accept="video/mp4,video/quicktime">
                                    </label>
