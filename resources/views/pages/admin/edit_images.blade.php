...
<body class="flex bg-gray-100">
    ...
    <main class="flex-1 ml-64">
        ...
        <div class="p-8">
            <h2 class="text-2xl font-semibold mb-4">Edit Images</h2>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                {{-- FORM EDIT --}}
                <form action="{{ route('images.update', $imagePaths->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="images_name" id="images_name"
                               value="{{ old('images_name', $imagePaths ->name) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex space-x-4 overflow-x-auto p-2 border rounded-md bg-gray-50">
                            @php
                                $images = json_decode($imagePaths->images_path);
                            @endphp
                    ...
                    <div class="mt-8 flex justify-end gap-3">
                        <a href="{{ route('images.index') }}" class="bg-gray-200 text-gray-700 font-semibold py-2 px-6 rounded-md hover:bg-gray-300">
                            Cancel
                        </a>
